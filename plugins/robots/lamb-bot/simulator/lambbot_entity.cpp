/**
 * @file <argos3/plugins/robots/lamb-bot/simulator/lambbot_entity.cpp>
 *
...
namespace argos {
   ...
   CLambBotEntity::CLambBotEntity(const std::string& str_id,
      ...
      try {
         ...
         m_pcDistanceScannerEquippedEntity =
            new CLambBotDistanceScannerEquippedEntity(this, "distance_scanner_0");
         ...
         m_pcTurretEntity = new CLambBotTurretEntity(this, "turret_0", cTurretAnchor);
   ...
   void CLambBotEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
         ...
         m_pcLEDEquippedEntity->AddLED(
            ...
            cTurretAnchor);
         /* Proximity sensor equipped entity */
         Real pRange = PROXIMITY_SENSOR_RING_RANGE;
         GetNodeAttributeOrDefault(t_tree, "proxi_range", pRange, pRange);
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CLambBotEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CLambBotEntity,
                   "lamb-bot",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The lamb-bot robot, developed in the Swarmanoid project.",
                   "The lamb-bot is a wheeled robot developed in the Swarmanoid Project. It is a\n"
                   ...
                   "lamb-bot in the arena. When the robot is untranslated and unrotated, the\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the lamb-bot. All\n"
                   ...
                   "lamb-bot. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by a lamb-bot can be received up to 3m. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <lamb-bot id=\"fb0\" rab_range=\"4\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </lamb-bot>\n"
                   "    ...\n"
                   ...
                   "system. By default, a message sent by a lamb-bot is 10 bytes long. By using the\n"
                   "'rab_data_size' attribute, you can change it to, i.e., 20 bytes as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <lamb-bot id=\"fb0\" rab_data_size=\"20\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </lamb-bot>\n"
                   "    ...\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <lamb-bot id=\"fb0\" omnidirectional_camera_aperture=\"80\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </lamb-bot>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CLambBotEntity);
