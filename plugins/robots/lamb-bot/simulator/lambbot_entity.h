/**
 * @file <argos3/plugins/robots/lamb-bot/simulator/lambbot_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef LAMBBOT_ENTITY_H
#define LAMBBOT_ENTITY_H

namespace argos {
   class CBatteryEquippedEntity;
   class CControllableEntity;
   class CLambBotDistanceScannerEquippedEntity;
   class CEmbodiedEntity;
   class CLambBotEntity;
   class CLambBotTurretEntity;
...
namespace argos {
   ...
   class CLambBotEntity : public CComposableEntity {
   ...
   public:
      ...
      CLambBotEntity(const std::string& str_id,
      ...
      inline CLambBotDistanceScannerEquippedEntity& GetDistanceScannerEquippedEntity() {
         return *m_pcDistanceScannerEquippedEntity;
      }

      inline CLambBotTurretEntity& GetTurretEntity() {
