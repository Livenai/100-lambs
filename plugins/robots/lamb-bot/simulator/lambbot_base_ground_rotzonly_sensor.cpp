/**
 * @file <argos3/plugins/robots/lamb-bot/simulator/lambbot_base_ground_rotzonly_sensor.cpp>
 *
...
#include "lambbot_base_ground_rotzonly_sensor.h"
...
namespace argos {
   ...
   CLambBotBaseGroundRotZOnlySensor::CLambBotBaseGroundRotZOnlySensor() :
   ...
   void CLambBotBaseGroundRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CLambBotBaseGroundRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         CCI_LambBotBaseGroundSensor::Init(t_tree);
         /* Parse noise level */
   ...
   void CLambBotBaseGroundRotZOnlySensor::Update() {
      /*
   ...
   void CLambBotBaseGroundRotZOnlySensor::Reset() {
   ...
   REGISTER_SENSOR(CLambBotBaseGroundRotZOnlySensor,
                   "lambbot_base_ground", "rot_z_only",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The lamb-bot base ground sensor.",
                   "This sensor accesses the lamb-bot base ground sensor. For a complete description\n"
                   "of its usage, refer to the ci_lambbot_base_ground_sensor.h interface. For the XML\n"
