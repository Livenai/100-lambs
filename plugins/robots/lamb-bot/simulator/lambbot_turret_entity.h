/**
 * @file <argos3/plugins/robots/lamb-bot/simulator/lambbot_turret_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef LAMBBOT_TURRET_ENTITY_H
#define LAMBBOT_TURRET_ENTITY_H
...
namespace argos {
   ...
   class CLambBotTurretEntity : public CEntity {
   ...
   public:
      ...
      CLambBotTurretEntity(CComposableEntity* pc_parent);
