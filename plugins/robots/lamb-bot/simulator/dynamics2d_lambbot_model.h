#ifndef DYNAMICS2D_LAMBBOT_MODEL_H
#define DYNAMICS2D_LAMBBOT_MODEL_H
...
namespace argos {
   ...
   class CDynamics2DLambBotModel : public CDynamics2DMultiBodyObjectModel {

   public:

      CDynamics2DLambBotModel(CDynamics2DEngine& c_engine,
                              CLambBotEntity& c_entity);
      virtual ~CDynamics2DLambBotModel();
