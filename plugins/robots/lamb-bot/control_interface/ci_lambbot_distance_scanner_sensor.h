/**
 * @file <argos3/plugins/robots/lamb-bot/control_interface/ci_lambbot_distance_scanner_sensor.h>
 *
...
#ifndef CCI_LAMBOT_DISTANCE_SCANNER_SENSOR_H
#define CCI_LAMBOT_DISTANCE_SCANNER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LambBotDistanceScannerSensor;
}
...
namespace argos {
   ...
   class CCI_LambBotDistanceScannerSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_LambBotDistanceScannerSensor() :
         m_tReadings(4){
      }
       ...
       * Destructor
       */
      virtual ~CCI_LambBotDistanceScannerSensor() {}
