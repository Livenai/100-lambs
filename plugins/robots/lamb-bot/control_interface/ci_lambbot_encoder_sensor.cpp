#include "ci_lambbot_encoder_sensor.h"
...
namespace argos {
  ...
  const CCI_LambBotEncoderSensor::SReading& CCI_LambBotEncoderSensor::GetReading() const {
    return m_sReading;
  }
...
#ifdef ARGOS_WITH_LUA
  void CCI_LambBotEncoderSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
  void CCI_LambBotEncoderSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
