/**
 * @file <argos3/plugins/robots/lamb-bot/control_interface/ci_lambbot_distance_scanner_actuator.h>
 *
...
#ifndef CCI_LAMBBOT_DISTANCE_SCANNER_ACTUATOR_H
#define CCI_LAMBBOT_DISTANCE_SCANNER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LambBotDistanceScannerActuator;
};
...
namespace argos {
   ...
   class CCI_LambBotDistanceScannerActuator: virtual public CCI_Actuator {
   ...
   public:
        ...
        * Destructor.
        */
      virtual ~CCI_LambBotDistanceScannerActuator() {}
