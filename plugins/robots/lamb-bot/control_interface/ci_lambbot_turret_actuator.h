/**
 * @file <argos3/plugins/robots/lamb-bot/control_interface/ci_lambbot_turret_actuator.h>
 *
...
#ifndef CCI_LAMBBOT_TURRET_ACTUATOR_H
#define CCI_LAMBBOT_TURRET_ACTUATOR_H

namespace argos {
   class CCI_LambBotTurretActuator;
}
...
namespace argos {
   ...
   class CCI_LambBotTurretActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Destructor.
       */
      virtual ~CCI_LambBotTurretActuator() {}
       ...
       * @param un_mode turret control mode, possible values are defined in CCI_LambBotTurretActuator
       */
