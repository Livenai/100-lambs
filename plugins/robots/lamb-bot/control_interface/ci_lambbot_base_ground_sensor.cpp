#include "ci_lambbot_base_ground_sensor.h"
...
namespace argos {
   ...
   CCI_LambBotBaseGroundSensor::CCI_LambBotBaseGroundSensor() :
      m_tReadings(8) {
   ...
   const CCI_LambBotBaseGroundSensor::TReadings& CCI_LambBotBaseGroundSensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_LambBotBaseGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_LambBotBaseGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
