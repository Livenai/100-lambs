/**
 * @file <argos3/plugins/robots/lamb-bot/control_interface/ci_lambbot_gripper_actuator.h>
 *
...
#ifndef CCI_LAMBOT_GRIPPER_ACTUATOR_H
#define CCI_LAMBOT_GRIPPER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LambBotGripperActuator;
}
...
namespace argos {
   ...
   class CCI_LambBotGripperActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Class constructor.
       */
      CCI_LambBotGripperActuator();

      /**
       * Class destructor.
       */
      virtual ~CCI_LambBotGripperActuator() {}
