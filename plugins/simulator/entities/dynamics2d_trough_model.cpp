#include "dynamics2d_trough_model.h"
...
namespace argos {
   ...
   CDynamics2DTroughModel::CDynamics2DTroughModel(CDynamics2DEngine& c_engine,
   ...
   REGISTER_STANDARD_DYNAMICS2D_OPERATIONS_ON_ENTITY(CTroughEntity, CDynamics2DTroughModel);
