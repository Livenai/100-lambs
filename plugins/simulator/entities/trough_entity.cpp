...
namespace argos {
   ...
   CTroughEntity::CTroughEntity(const std::string& str_id,
   ...
   void CTroughEntity::EnableLEDs(CLEDMedium& c_medium) {
   ...
   void CTroughEntity::DisableLEDs() {
   ...
   void CTroughEntity::AddLED(const CVector3& c_offset,
