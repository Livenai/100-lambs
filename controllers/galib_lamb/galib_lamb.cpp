...
/****************************************/
/****************************************/
UInt8 CGalibLamb::id_counter = 0;
vector<CVector2> CGalibLamb::water_troughs;
vector<CVector2> CGalibLamb::food_troughs;
// vector<CVector2> CGalibLamb::beds;

CGalibLamb::CGalibLamb() :
    wheels_act(NULL),
    proxi_sens(NULL),
    pos_sens(NULL),
    rb_sens(NULL),
...
void CGalibLamb::Init(TConfigurationNode& t_node) {
...
void CGalibLamb::ShowDebugInformation(bool show){
...
CVector2 CGalibLamb::CalculateDirection(CVector2 target){
...
void CGalibLamb::GoTo(CVector2 target) {
...
void CGalibLamb::UpdatePriority(){
...
//FIXME muy cutrillo
bool CGalibLamb::IsInPlace(CVector2 target){
    Real dis = (pos - target).Length();
    return dis < radius;
}


CVector2 CGalibLamb::GetClosestPoint(vector<CVector2> *targets){
...
void CGalibLamb::SetIdNum(CGalibLamb* robot){
    robot->id_num = id_counter ++;
}

void CGalibLamb::SetTroughs(){
...
CVector2 CGalibLamb::GetCorrectedPos(){
...
CVector3 CGalibLamb::GetDirection(){
    return CVector3(0,1,0);
}

void CGalibLamb::Destroy(){
    CGalibLamb::id_counter --;
}
 ...
 */
REGISTER_CONTROLLER(CGalibLamb, "galib_lamb_controller")
