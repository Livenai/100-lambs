...
#include <loop_functions/galib_lamb_loop_functions/galib_lamb_loop_functions.h>
...
float LaunchARGoS(GAGenome& c_genome) {
   ...
   static CGALibLambLoopFunctions& cLoopFunctions = dynamic_cast<CGALibLambLoopFunctions&>(cSimulator.GetLoopFunctions());
   /*
...
int main(int argc, char** argv) {
   ...
   cSimulator.SetExperimentFileName("experiments/galib_lamb.argos");
